...
## Installation
To install run **git clone https://github.com/CIERA-Transients/Imaging_pipelines.git** and then ... do: install script which create an environment with all the needed software and packages. Recommand creating an enivornment.
